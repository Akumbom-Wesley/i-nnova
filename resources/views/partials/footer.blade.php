<footer class="mt-24 bg-ink text-paper/80">
    <div class="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 md:grid-cols-4">
        ...
        <div>
            <h2 class="text-xs font-semibold uppercase tracking-widest text-paper/50">Company</h2>
            <ul class="mt-4 space-y-2 text-sm">
                @foreach ([
                    ...
                    <li><a href="{{ url($href) }}" class="transition-colors hover:text-paper">{{ $label }}</a></li>
                @endforeach
            </ul>
        </div>

        <div>
            <h2 class="text-xs font-semibold uppercase tracking-widest text-paper/50">Contact</h2>
    ...
    <div class="border-t border-ink-line">
        <div class="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-6 text-xs sm:flex-row sm:items-center sm:justify-between sm:px-6">
            ...
            <div class="flex gap-6">
                <a href="{{ url('/privacy') }}" class="transition-colors hover:text-paper">Privacy</a>
                <a href="{{ url('/terms') }}" class="transition-colors hover:text-paper">Terms</a>
            </div>
        </div>
    </div>
</footer>
